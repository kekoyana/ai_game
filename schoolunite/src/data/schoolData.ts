...
export const schoolRooms: Room[] = [
  // 屋上
  createRoom('roof', '屋上', 'roof', 'roof', 1, 0, 4, 3, AccessLevel.CAUTION, undefined, false),
  ...
  createRoom('music', '音楽室', 'musicroom', 2, 3, 3, 2, 1),
  ...
  createRoom('infirmary', '保健室', 'infirmary', 1, 1, 3, 2, 1, AccessLevel.CAUTION),
  ...
  createRoom('pool', 'プール', 'pool', 'ground', 2, 3, 2, 1, AccessLevel.CAUTION, undefined, false),
